...
- TP 1 : BaseTP1Game.java
- Exercice 4 : BaseEx4Array.java
- Exercice 5 : BaseEx5String.java
- Exercice 6 : BaseEx6Operation.java
- TP 2 : BaseTP2Resto.java
- Exercice 6 (7 en fait!) : Factorielle.java